...
from measurement.views import DemoView, AddMeasurement, SensorUpdateView#, create_measurement #, create_sensor, create_measurement
...
urlpatterns = [
    ...
    # #path('new_sensor/', create_sensor),
    # #path("new_measurement", create_measurement),
]
